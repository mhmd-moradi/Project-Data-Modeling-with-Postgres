...
def process_song_file(cur, filepath):
    '''
    Inserts values extracted from a song file into songs and artists tables.
...
def process_log_file(cur, filepath):
    '''
    Inserts values extracted from a log file into time, users, and songplays tables.
...
def process_data(cur, conn, filepath, func):
    '''
    Iterates over all json files in a given folder and executes the convenient process function (process_log_file for log_data folder and process_song_file for song_data folder)
